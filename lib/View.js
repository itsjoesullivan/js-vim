...
View.prototype.getArray = function() {
	...
	textArray[visibleCursorIndex] = cursorLine.substring(0,cursor.char) + cursorLine.substring(cursor.char,cursor.char+1).cursor + cursorLine.substring(cursor.char+1);
